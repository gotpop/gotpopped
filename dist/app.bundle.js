...
// module
exports.push([module.i, "a,abbr,acronym,address,applet,article,aside,audio,b,big,blockquote,body,canvas,caption,center,cite,code,dd,del,details,dfn,div,dl,dt,em,embed,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,header,hgroup,html,i,iframe,img,ins,kbd,label,legend,li,mark,menu,nav,object,ol,output,p,pre,q,ruby,s,samp,section,small,span,strike,strong,sub,summary,sup,table,tbody,td,tfoot,th,thead,time,tr,tt,u,ul,var,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1}ol,ul{list-style:none}blockquote,q{quotes:none}blockquote:after,blockquote:before,q:after,q:before{content:\"\";content:none}table{border-collapse:collapse;border-spacing:0}*{box-sizing:border-box}html{overflow-y:scroll;overflow-x:hidden}body{min-height:100vh;display:flex;justify-content:start;align-items:center;flex-direction:row;flex-wrap:wrap}.column{display:flex;justify-content:center}body{background:#ff0;color:rgba(0,0,0,.6);font-family:sans-serif;max-width:100%}.site{display:flex;justify-content:center;flex-wrap:wrap;align-items:start;min-height:90vh;width:100%}.menu-open .site,.site{transition:all .6s ease}.menu-open .site{filter:blur(5px)}section{background:rgba(0,0,0,.6);padding:2rem;flex:1 1 auto;box-sizing:border-box;color:hsla(0,0%,100%,.5)}#wrap-site{max-width:100%;overflow:hidden}@media (max-width:600px){body header{min-height:100vh}body header,body header ul{display:flex;flex-direction:column;justify-content:flex-start}#wrap-site{max-width:100%;display:flex;transform:translateX(-200px);transition:all .6s ease}}.mobile.menu-open #wrap-site{transition:all .6s ease;transform:translateX(0)}header{flex:1 1 80%;padding:2rem;background:hsla(0,0%,100%,.5);color:#999;text-align:center;align-self:flex-start;display:flex;justify-content:space-between;position:relative;z-index:9999}header .ma-menu{display:flex;margin:1rem}header .ma-menu li{display:flex}header .ma-menu .ma-class a{padding:1rem 2rem;margin-left:1rem}header .ma-menu .ma-class a:hover{transition:all .5s ease;background:#ff0}header .ma-menu .ma-class.active a{background:green}.mobile-menu-trigger{background:green;padding:1rem;display:none;position:absolute;top:0;right:-40px}.mobile .mobile-menu-trigger{display:block}footer{flex:1 1 100%;padding:2rem;color:#999;text-align:center;align-self:flex-end}canvas,footer{background:#fff}canvas{position:fixed;left:0;top:0;z-index:-1}.view{display:flex;max-width:100vw;margin:2rem}.view-item{margin:2rem;min-width:calc(100% - 4rem);transition:all 1s ease}.first{transform:translateX(0);animation-name:slideout;animation-fill-mode:forwards}.first,.last{animation-duration:1s}.last{transform:translateX(calc(100% - 2rem));animation-name:slidein;animation-fill-mode:forwards}.solo{animation-name:none}@keyframes slidein{0%{transform:translateX(100%);opacity:0}to{transform:translateX(calc(-100% - 4rem));opacity:1}}@keyframes slideout{0%{transform:translateX(0);opacity:1}to{transform:translateX(-100%);opacity:0;display:none}}span.icon-class{height:50px;width:50px}span.icon-class:hover svg{fill:pink}.portfolio-thumbnails{display:flex;flex-wrap:wrap}.portfolio-thumbnail{background:#ff0;min-height:10rem;margin:1rem;cursor:pointer;flex:1 1 150px}.portfolio-thumbnail.active{background:#0f0}#portfolioWrap{min-height:10rem;background:pink;color:#000;padding:2rem;display:flex}img{margin-top:2rem;max-width:100%;height:auto}h2{font-size:2rem;margin-bottom:2rem}", ""]);
