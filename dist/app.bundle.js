...
var _triangle = __webpack_require__(78);
...
var _cube = __webpack_require__(73);

var _cube2 = _interopRequireDefault(_cube);

var _bino = __webpack_require__(71);

var _bino2 = _interopRequireDefault(_bino);

var _lollipop = __webpack_require__(74);

var _lollipop2 = _interopRequireDefault(_lollipop);

var _codepen = __webpack_require__(75);

var _codepen2 = _interopRequireDefault(_codepen);

var _github = __webpack_require__(76);

var _github2 = _interopRequireDefault(_github);

var _linkedin = __webpack_require__(77);
...
var Header = function () {
  ...
  _createClass(Header, [{
    ...
    value: function makeHeader() {
      ...
      var makeIcon = new _icons2.default('lollipop', 'icon-class').build();
...
var _PortfolioItem = __webpack_require__(30);
...
// module
exports.push([module.i, "/* http://meyerweb.com/eric/tools/css/reset/\r\n   v2.0 | 20110126\r\n   License: none (public domain)\r\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block; }\n\nbody {\n  line-height: 1; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\n* {\n  box-sizing: border-box; }\n\nhtml {\n  overflow-y: scroll;\n  overflow-x: hidden; }\n\nbody {\n  min-height: 100vh;\n  display: flex;\n  justify-content: start;\n  align-items: center;\n  flex-direction: row;\n  flex-wrap: wrap;\n  background: #eee;\n  max-width: 100%;\n  overflow-x: hidden; }\n\nimg {\n  margin-top: 2rem;\n  max-width: 100%;\n  height: auto; }\n\n.site {\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n  align-items: start;\n  min-width: 100%; }\n\n.menu-open .site {\n  filter: blur(2px);\n  transition: all .6s ease;\n  transition-delay: .6s; }\n\n.wrap-site {\n  max-width: 100%;\n  flex: 1 1 auto; }\n  .mobile .wrap-site {\n    max-width: 100%;\n    display: flex;\n    transform: translateX(-200px);\n    transition: all .5s ease; }\n  .mobile.menu-open .wrap-site {\n    transform: translateX(0px); }\n\n@font-face {\n  font-family: 'Code-Pro-Black-LC';\n  src: url(" + __webpack_require__(7) + ");\n  src: url(" + __webpack_require__(7) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(41) + ") format(\"woff2\"), url(" + __webpack_require__(40) + ") format(\"woff\"), url(" + __webpack_require__(39) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Black';\n  src: url(" + __webpack_require__(8) + ");\n  src: url(" + __webpack_require__(8) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(44) + ") format(\"woff2\"), url(" + __webpack_require__(43) + ") format(\"woff\"), url(" + __webpack_require__(42) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Demo';\n  src: url(" + __webpack_require__(9) + ");\n  src: url(" + __webpack_require__(9) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(47) + ") format(\"woff2\"), url(" + __webpack_require__(46) + ") format(\"woff\"), url(" + __webpack_require__(45) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Bold-LC';\n  src: url(" + __webpack_require__(10) + ");\n  src: url(" + __webpack_require__(10) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(50) + ") format(\"woff2\"), url(" + __webpack_require__(49) + ") format(\"woff\"), url(" + __webpack_require__(48) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Light-LC';\n  src: url(" + __webpack_require__(11) + ");\n  src: url(" + __webpack_require__(11) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(53) + ") format(\"woff2\"), url(" + __webpack_require__(52) + ") format(\"woff\"), url(" + __webpack_require__(51) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Light-Demo';\n  src: url(" + __webpack_require__(12) + ");\n  src: url(" + __webpack_require__(12) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(56) + ") format(\"woff2\"), url(" + __webpack_require__(55) + ") format(\"woff\"), url(" + __webpack_require__(54) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-LC';\n  src: url(" + __webpack_require__(13) + ");\n  src: url(" + __webpack_require__(13) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(59) + ") format(\"woff2\"), url(" + __webpack_require__(58) + ") format(\"woff\"), url(" + __webpack_require__(57) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Light';\n  src: url(" + __webpack_require__(14) + ");\n  src: url(" + __webpack_require__(14) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(62) + ") format(\"woff2\"), url(" + __webpack_require__(61) + ") format(\"woff\"), url(" + __webpack_require__(60) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro-Bold';\n  src: url(" + __webpack_require__(15) + ");\n  src: url(" + __webpack_require__(15) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(65) + ") format(\"woff2\"), url(" + __webpack_require__(64) + ") format(\"woff\"), url(" + __webpack_require__(63) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Code-Pro';\n  src: url(" + __webpack_require__(16) + ");\n  src: url(" + __webpack_require__(16) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(68) + ") format(\"woff2\"), url(" + __webpack_require__(67) + ") format(\"woff\"), url(" + __webpack_require__(66) + ") format(\"truetype\"); }\n\na {\n  text-decoration: none; }\n\nhtml {\n  font-family: 'Code-Pro-LC';\n  font-size: 16px; }\n\nh1 {\n  font-family: 'Code-Pro-Light';\n  font-size: 2rem;\n  line-height: 1.5em; }\n\nh2 {\n  font-family: 'Code-Pro-Light';\n  line-height: 1.5em;\n  font-size: 2rem; }\n\nh1, h2, h3, h4, h5, h6 {\n  margin-bottom: 1em; }\n\np {\n  line-height: 1.5em; }\n\nli {\n  line-height: 1.5em; }\n\n.btn {\n  padding: 1rem 2rem;\n  background: red;\n  display: flex;\n  align-items: center;\n  margin: 2rem 0 0 0;\n  transition: all .6s ease;\n  color: #fff; }\n  .mobile .btn {\n    max-width: 100%; }\n\n.btn .icon {\n  margin-left: 2em;\n  width: 50px;\n  height: auto; }\n  .btn .icon svg {\n    width: 50px;\n    height: auto;\n    fill: #fff; }\n\n.header {\n  flex: 1 1 80%;\n  padding: 2rem;\n  background: rgba(255, 255, 255, 0.5);\n  color: #999;\n  text-align: center;\n  display: flex;\n  justify-content: space-between;\n  position: relative;\n  z-index: 9999;\n  align-items: center; }\n  .mobile .header {\n    justify-content: flex-start;\n    min-height: 100vh;\n    display: flex;\n    flex-direction: column;\n    width: 200px;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start; }\n\n.header-logo-a-wrap {\n  cursor: pointer; }\n\n.header-logo-wrap {\n  display: flex;\n  align-items: center; }\n  .mobile .header-logo-wrap {\n    flex-direction: column;\n    align-items: center; }\n\n.header-logo-a-wrap {\n  color: #3d3d3d; }\n\n.header-title {\n  margin: 0;\n  line-height: 0.9em;\n  position: relative;\n  top: -5px; }\n  .mobile .header-title {\n    margin-bottom: 1rem;\n    color: #3d3d3d; }\n\n.header-menu {\n  display: flex;\n  margin: 1rem; }\n  .mobile .header-menu {\n    flex-direction: column; }\n\n.header-menu-list {\n  display: flex;\n  margin: 0; }\n  .mobile .header-menu-list {\n    margin-bottom: 1rem; }\n  .header-menu-list a {\n    flex: 1 1 auto;\n    padding: 1rem 2rem;\n    cursor: pointer;\n    color: #3d3d3d; }\n    .header-menu-list a:hover {\n      transition: all 0.5s ease;\n      background: #999; }\n  .header-menu-list.active a {\n    color: #fff;\n    background: red; }\n\n.header .icon-class {\n  max-height: 50px;\n  max-width: 50px;\n  margin-right: 1rem; }\n  .mobile .header .icon-class {\n    margin: 0 0 1rem; }\n  .header .icon-class svg {\n    width: 100%; }\n  .header .icon-class:hover svg {\n    fill: red; }\n\n.mobile-menu-trigger {\n  display: none;\n  background: #fff;\n  padding: 1rem;\n  position: absolute;\n  top: 0;\n  right: -124px; }\n  .mobile .mobile-menu-trigger {\n    display: flex; }\n\n.mobile-menu-trigger-burger,\n.mobile-menu-trigger-burger:after,\n.mobile-menu-trigger-burger:before {\n  cursor: pointer;\n  border-radius: 1px;\n  height: 5px;\n  width: 30px;\n  background: rgba(153, 153, 153, 0.8);\n  position: absolute;\n  top: 20px;\n  display: block;\n  content: \"\";\n  transition: all 300ms ease-in-out; }\n\n.mobile-menu-trigger-burger:before {\n  top: -10px; }\n\n.mobile-menu-trigger-burger:after {\n  top: 10px; }\n\n.menu-open .mobile-menu-trigger-burger {\n  background-color: transparent; }\n\n.menu-open .mobile-menu-trigger-burger:after,\n.menu-open .mobile-menu-trigger-burger:before {\n  top: 0; }\n\n.menu-open .mobile-menu-trigger-burger:before {\n  transform: rotate(45deg); }\n\n.menu-open .mobile-menu-trigger-burger:after {\n  transform: rotate(-45deg); }\n\n.mobile-menu-trigger-text {\n  display: block;\n  margin-left: 3rem; }\n\nfooter {\n  flex: 1 1 100%;\n  padding: 2rem;\n  background: white;\n  color: #999;\n  text-align: center;\n  align-self: flex-end; }\n\ncanvas {\n  background: white;\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: -1; }\n\n.wrap-view {\n  min-height: calc(100vh - 200px);\n  display: flex;\n  justify-content: center;\n  align-items: center; }\n\n.view {\n  display: flex;\n  max-width: 800px; }\n\n.work .view {\n  align-self: flex-start; }\n\n.view-item {\n  display: flex;\n  flex-wrap: wrap;\n  margin: 0 2rem 2rem 2rem;\n  animation-name: slidein;\n  animation-duration: .4s;\n  animation-fill-mode: forwards; }\n  .work .view-item {\n    margin-top: 2rem; }\n  .mobile.work .view-item,\n  .mobile.skills .view-item {\n    margin-top: 5rem; }\n\n@keyframes slidein {\n  from {\n    transform: translateX(50%);\n    opacity: 0; }\n  to {\n    transform: translateX(0%);\n    opacity: 1; } }\n\n.skills-intro {\n  margin: .5rem; }\n\n.skills-list {\n  display: flex;\n  flex-wrap: wrap;\n  color: #999;\n  margin-top: 2rem; }\n  .skills-list li {\n    font-size: 1rem;\n    padding: 1em;\n    background: #fff;\n    flex: 1 1 40%;\n    margin: .5rem; }\n    .skills-list li:hover {\n      background: #eee;\n      transition: all .5s ease; }\n\n.social svg {\n  max-width: 100px;\n  fill: #999; }\n\n.social {\n  margin: 2rem; }\n\n.social-link {\n  margin: 1rem; }\n\n.portfolio-thumbnails {\n  display: flex;\n  flex-wrap: wrap;\n  flex: 1 1 auto; }\n\n.portfolio-thumbnail {\n  background: #fff;\n  padding: 1em 2em;\n  margin: .5rem;\n  cursor: pointer;\n  flex: 1 1 auto;\n  text-align: center;\n  transition: all .5s ease; }\n  .portfolio-thumbnail.active {\n    color: red; }\n\n.portfolio-wrap {\n  padding: .5rem;\n  display: flex;\n  min-height: 60vh; }\n\n.view-item-portfolio {\n  animation-name: slideinPorfolio;\n  animation-duration: .4s;\n  animation-fill-mode: forwards; }\n\n@keyframes slideinPorfolio {\n  from {\n    transform: translateX(50%);\n    opacity: 0; }\n  to {\n    transform: translateX(0%);\n    opacity: 1; } }\n", ""]);
