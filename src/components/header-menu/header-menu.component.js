...
class HeaderMenuComponent extends Component {
  ...
  render() {
    return (
        <section className="he__menu-wrap">
          <nav className={this.state.active ? 'he__menu-active he__menu': 'he__menu'}>
            <NavLink className="he__menu-item" to="/" exact={true} activeClassName='active'>
              <span>HOME</span>
              <span className="he__menu-icon">
            ...
            <NavLink className="he__menu-item" to="/work" activeClassName='he__menu-item-active'>
              <span>WORK</span>
              <span className="he__menu-icon">
            ...
            <NavLink className="he__menu-item" to="/skills" activeClassName='he__menu-item-active'>
                <span>SKILLS</span>
                <span className="he__menu-icon">
