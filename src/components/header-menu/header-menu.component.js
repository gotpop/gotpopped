...
class HeaderMenuComponent extends Component {
  ...
  render() {
    return (
        <section className="header-menu">
          <nav className={this.state.active ? 'menu-active': null}>
            <NavLink className="header-menu-item" to="/" exact={true} activeClassName='active'>
              ...
              <NavLink className="header-menu-item" to="/work" activeClassName='active'>
                <span>WORK</span>
                <span className="icon">
              ...
              <NavLink className="header-menu-item" to="/skills" activeClassName='active'>
                  <span>SKILLS</span>
                  <span className="icon">
        ...
        {/* <MenuTrigger onClick={this.toggleClass}></MenuTrigger> */}

        <div id="mobileMenuTrigger" className="mobile-menu-trigger" onClick={this.toggleClass}>
