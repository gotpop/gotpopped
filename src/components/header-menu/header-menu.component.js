...
class HeaderMenuComponent extends Component {
  ...
  render() {
    return (
      ...
      <nav class="header-menu" *ngIf="menuOpen">
  <div class="header-menu-item" routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }" (click)="closeMenu()">
    <span>HOME</span>
    <span class="icon">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="73.4 103.2 471.2 430.5"
        enable-background="new 73.4 103.2 471.2 430.5" xml:space="preserve">
        <g>
  ...
  <div class="header-menu-item" routerLink="/work" routerLinkActive="active" (click)="closeMenu()">
    <span>WORK</span>
    <span class="icon">
      <svg version="1.1" xmlns:svg="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="37.5 170.9 537 297.2" enable-background="new 37.5 170.9 537 297.2"
        xml:space="preserve">
  ...
  <div class="header-menu-item" routerLink="/skills" routerLinkActive="active" (click)="closeMenu()">
    <span>SKLLS</span>
    <span class="icon">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="103.9 117.4 404.8 404.7"
        enable-background="new 103.9 117.4 404.8 404.7" xml:space="preserve">
...
<app-menu-trigger (click)="handleMenuToggle()"></app-menu-trigger>
