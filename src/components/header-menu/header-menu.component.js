  ...
  render() {
    return (
      <nav className="header-menu">
        ...
        enable-background="new 73.4 103.2 471.2 430.5">
        <g>
        ...
        <NavLink className="header-menu-item" to="/work" activeClassName='active'>
            <span>WORK</span>
            <span className="icon">
            <svg version="1.1" x="0px" y="0px" viewBox="37.5 170.9 537 297.2" enable-background="new 37.5 170.9 537 297.2">
        ...
        enable-background="new 103.9 117.4 404.8 404.7">
