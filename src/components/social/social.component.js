    ...
    return (
      <div id="social" className="social">
        <nav className="social-nav">
          <a className="social-link" href="http://codepen.io/gotpop/">
            <span className="icon">
              <svg id="icon-codepen" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 50 50">
          ...
          <a className="social-link" href="http://uk.linkedin.com/in/gotpop">
            <span className="icon">
              <svg id="icon-linkedin" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 50 50">
                <path id="linkedin" fill="%231D1D1B" d="M46.3,0H3.7C1.7,0,0,1.6,0,3.6v42.8c0,2,1.7,3.6,3.7,3.6h42.6c2,0,3.7-1.6,3.7-3.6V3.6 C50,1.6,48.3,0,46.3,0z M14.8,42.6H7.4V18.7h7.4V42.6z M11.1,15.5c-2.4,0-4.3-1.9-4.3-4.3c0-2.4,1.9-4.3,4.3-4.3 c2.4,0,4.3,1.9,4.3,4.3C15.4,13.6,13.5,15.5,11.1,15.5z M42.6,42.6h-7.4V31c0-2.8-0.1-6.3-3.9-6.3c-3.9,0-4.5,3-4.5,6.1v11.8h-7.4 V18.7h7.1V22h0.1c1-1.9,3.4-3.9,7-3.9c7.5,0,8.9,4.9,8.9,11.4V42.6z"></path>
              </svg>
            </span>
          </a>
          <a className="social-link" href="https://github.com/gotpop">
            <span className="icon">
              <svg id="icon-github" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 50 50">
                <path id="github_1_" fill-rule="evenodd" clip-rule="evenodd" fill="%231D1D1B" d="M25,0C11.2,0,0,11.5,0,25.6C0,37,7.2,46.6,17.1,50 c1.2,0.2,1.7-0.6,1.7-1.2c0-0.6,0-2.6,0-4.8c-7,1.6-8.4-3-8.4-3c-1.1-3-2.8-3.8-2.8-3.8c-2.3-1.6,0.2-1.6,0.2-1.6 c2.5,0.2,3.8,2.6,3.8,2.6c2.2,3.9,5.8,2.8,7.3,2.1c0.2-1.7,0.9-2.8,1.6-3.4C14.9,36.3,9,34.1,9,24.3c0-2.8,1-5.1,2.6-6.9 c-0.3-0.6-1.1-3.3,0.2-6.8c0,0,2.1-0.7,6.9,2.6c2-0.6,4.1-0.9,6.3-0.9c2.1,0,4.3,0.3,6.3,0.9c4.8-3.3,6.9-2.6,6.9-2.6 c1.4,3.5,0.5,6.1,0.2,6.8c1.6,1.8,2.6,4.1,2.6,6.9c0,9.8-5.8,12-11.4,12.6c0.9,0.8,1.7,2.4,1.7,4.7c0,3.4,0,6.2,0,7 c0,0.7,0.4,1.5,1.7,1.2C42.8,46.6,50,37,50,25.6C50,11.5,38.8,0,25,0z"></path>
              </svg>
            </span>
          </a>
        </nav>
